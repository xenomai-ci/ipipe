 ...
 */
static inline void __switch_mm_irqs_off(struct mm_struct *prev, struct mm_struct *next,
...
static inline void switch_mm_irqs_off(struct mm_struct *prev,
				      ...
				      struct task_struct *tsk)
{
	__switch_mm_irqs_off(prev, next, tsk, false);
}
...
#define mmswitch_irq_sync true
	...
	for (;;) {
		...
		barrier();
		__switch_mm_irqs_off(prev, next, tsk, mmswitch_irq_sync);
