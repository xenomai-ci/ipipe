...
static void aic5_hard_mask(struct irq_data *d, struct irq_chip_generic *gc)
{
...
static void aic5_hard_unmask(struct irq_data *d, struct irq_chip_generic *gc)
{
	irq_reg_writel(d->hwirq, gc->reg_base + AT91_AIC5_SSR);
