 ...
 *
 *  $Id: 21285.c 2959 2007-03-30 04:02:22Z cooloney $
 */
...
static int __init serial21285_init(void)
{
	...
	printk(KERN_INFO "Serial: 21285 driver $Revision: 2959 $\n");
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Intel Footbridge (21285) serial driver $Revision: 2959 $");
