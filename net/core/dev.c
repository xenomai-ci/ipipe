...
static struct net_dma_struct net_dma = {
	.client = {
...
static void net_dma_rebalance(struct net_dma_struct *net_dma)
{
...
{
	int i, found = 0, pos = -1;
	struct net_dma_struct *net_dma =
		container_of(client, struct net_dma_struct, client);
